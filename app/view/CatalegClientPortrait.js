...
Ext.define('Preventa.view.CatalegClientPortrait', {
    extend: 'Ext.Container',
    xtype: 'CatalegClientPortrait',
    id: 'CatalegClientPortrait',
    fullscreen: true,
    ...
    removeThis: function(){
    	console.log("removeCatalegClientPortrait()");
