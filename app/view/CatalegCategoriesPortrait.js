...
Ext.define('Preventa.view.CatalegCategoriesPortrait', {
    extend: 'Ext.Container',
    xtype: 'CatalegCategoriesPortrait',
    id: 'CatalegCategoriesPortrait',
    fullscreen: true,
    
    initialize: function(){
    	console.log("Initialize view: CatalegCategoriesPortrait");
