...
Ext.define('Preventa.view.CatalegProductes', {
    extend: 'Ext.Container',
    xtype: 'CatalegProductes',
    id: 'CatalegProductes',
    fullscreen: true,
    ...
    initialize: function(){
    	console.log("Initialize view: CatalegProductes");
	...
	isCreated: function(){
		console.log("cataleg iscreated with: " + this.getItems()['items'].length);
